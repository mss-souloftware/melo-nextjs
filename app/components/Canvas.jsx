...
export default function Canvas() {
  ...
  useEffect(() => {
    ...
    // Create a GSAP timeline for canvasWrapper
    ...
    // Animate canvasWrapper position from right to center with Expo.easeOut
    timeline.fromTo(
      canvasWrapperRef.current,
      { right: "-120px" }, // Initial position off-screen to the right
      {
        right: "calc(50% - 310px)", // Centering based on canvasWrapper width
        duration: 2,
  ...
  return (
    ...
    >
      <Link href="#" className={`${styles.buyBtn} flex items-center bg-[#FFC700] px-2 py-1`}>
